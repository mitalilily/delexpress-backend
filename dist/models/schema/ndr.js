...
exports.ndr_events = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const b2cOrders_1 = require("./b2cOrders");
const users_1 = require("./users");
exports.ndr_events = (0, pg_core_1.pgTable)('ndr_events', {
    ...
    status: (0, pg_core_1.varchar)('status', { length: 60 }).notNull(), // e.g., ndr, undelivered, address_issue
    reason: (0, pg_core_1.varchar)('reason', { length: 300 }),
    remarks: (0, pg_core_1.varchar)('remarks', { length: 500 }),
    attempt_no: (0, pg_core_1.varchar)('attempt_no', { length: 20 }),
