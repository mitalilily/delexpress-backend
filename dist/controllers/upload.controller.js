...
exports.getPresignedDownloadUrl = exports.createPresignedUrl = void 0;
...
const createPresignedUrl = async (req, res) => {
    ...
    try {
        const data = await (0, upload_service_1.presignUpload)({
            filename,
            contentType,
            userId: sub,
            folderKey: folder,
...
const getPresignedDownloadUrl = async (req, res) => {
    try {
        ...
        const result = await (0, upload_service_1.presignDownload)(keys);
