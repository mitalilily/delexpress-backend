...
exports.upsertVolumetricRulesController = exports.getVolumetricRulesController = exports.importAdditionalChargesController = exports.upsertAdditionalChargesController = exports.getAdditionalChargesController = exports.deleteZoneStateController = exports.bulkCreateZoneStatesController = exports.createZoneStateController = exports.listZoneStatesController = void 0;
const b2bPricingConfig_service_1 = require("../../../models/services/b2bPricingConfig.service");
...
// Zone States
// -------------------------
const listZoneStatesController = async (req, res) => {
    try {
        const states = await (0, b2bPricingConfig_service_1.listZoneStates)({
            zoneId: req.query.zone_id ?? undefined,
            stateName: req.query.state_name ?? undefined,
...
exports.listZoneStatesController = listZoneStatesController;
const createZoneStateController = async (req, res) => {
    try {
        const state = await (0, b2bPricingConfig_service_1.createZoneState)({
...
exports.createZoneStateController = createZoneStateController;
const bulkCreateZoneStatesController = async (req, res) => {
    try {
        ...
        const states = await (0, b2bPricingConfig_service_1.bulkCreateZoneStates)(zoneId, stateNames, parseCourierScope(req));
...
exports.bulkCreateZoneStatesController = bulkCreateZoneStatesController;
const deleteZoneStateController = async (req, res) => {
    try {
        await (0, b2bPricingConfig_service_1.deleteZoneState)(req.params.id);
...
exports.deleteZoneStateController = deleteZoneStateController;
// -------------------------
// Additional Charges
// -------------------------
const getAdditionalChargesController = async (req, res) => {
    try {
        const planId = req.query.plan_id ?? req.query.planId ?? undefined;
        let charges = await (0, b2bPricingConfig_service_1.getAdditionalCharges)({
            courierScope: parseCourierScope(req),
            includeGlobal: req.query.include_global !== 'false',
            planId,
        });
        ...
        if (!charges) {
            charges = await (0, b2bPricingConfig_service_1.seedDefaultAdditionalCharges)({
                courierScope: parseCourierScope(req),
                planId,
            });
        }
...
exports.getAdditionalChargesController = getAdditionalChargesController;
const upsertAdditionalChargesController = async (req, res) => {
    try {
        const charges = await (0, b2bPricingConfig_service_1.upsertAdditionalCharges)({
            ...
            minimumChargeableAmount: req.body.minimumChargeableAmount ?? req.body.minimum_chargeable_amount,
            minimumChargeableWeight: req.body.minimumChargeableWeight ?? req.body.minimum_chargeable_weight,
            minimumChargeableMethod: req.body.minimumChargeableMethod ??
            ...
            demurrageMethod: req.body.demurrageMethod ?? req.body.demurrage_method ?? 'whichever_is_higher',
            publicHolidayPickupCharge: req.body.publicHolidayPickupCharge ?? req.body.public_holiday_pickup_charge,
            fuelSurchargePercentage: req.body.fuelSurchargePercentage ?? req.body.fuel_surcharge_percentage,
            ...
            timeSpecificMethod: req.body.timeSpecificMethod ?? req.body.time_specific_method ?? 'whichever_is_higher',
            ...
            mallDeliveryMethod: req.body.mallDeliveryMethod ?? req.body.mall_delivery_method ?? 'whichever_is_higher',
            deliveryReattemptPerKg: req.body.deliveryReattemptPerKg ?? req.body.delivery_reattempt_per_kg,
            deliveryReattemptPerAwb: req.body.deliveryReattemptPerAwb ?? req.body.delivery_reattempt_per_awb ?? 500,
            deliveryReattemptMethod: req.body.deliveryReattemptMethod ??
            ...
            liabilityMethod: req.body.liabilityMethod ?? req.body.liability_method ?? 'whichever_is_lower',
...
exports.upsertAdditionalChargesController = upsertAdditionalChargesController;
const importAdditionalChargesController = async (req, res) => {
    try {
        if (!req.file?.buffer) {
        ...
        const result = await (0, b2bPricingConfig_service_1.importAdditionalChargesFromCsv)(req.file.buffer, {
            courierScope: {
...
exports.importAdditionalChargesController = importAdditionalChargesController;
// -------------------------
// Volumetric Rules
// -------------------------
const getVolumetricRulesController = async (req, res) => {
    try {
        const rules = await (0, b2bPricingConfig_service_1.getVolumetricRules)({
            courierScope: parseCourierScope(req),
            includeGlobal: req.query.include_global !== 'false',
        });
...
exports.getVolumetricRulesController = getVolumetricRulesController;
const upsertVolumetricRulesController = async (req, res) => {
    try {
        const rules = await (0, b2bPricingConfig_service_1.upsertVolumetricRules)({
            volumetricDivisor: req.body.volumetricDivisor ?? req.body.volumetric_divisor,
            cftFactor: req.body.cftFactor ?? req.body.cft_factor,
            minimumVolumetricWeight: req.body.minimumVolumetricWeight ?? req.body.minimum_volumetric_weight,
            courierScope: parseCourierScope(req),
        });
        res.json({ success: true, data: rules });
    }
...
exports.upsertVolumetricRulesController = upsertVolumetricRulesController;
