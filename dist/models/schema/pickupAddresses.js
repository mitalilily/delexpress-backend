...
exports.addresses = (0, pg_core_1.pgTable)('addresses', {
    ...
    userId: (0, pg_core_1.uuid)('userId').references(() => users_1.users.id, { onDelete: 'cascade' }),
...
exports.pickupAddresses = (0, pg_core_1.pgTable)('pickup_addresses', {
    id: (0, pg_core_1.uuid)('id').defaultRandom().primaryKey(),
    userId: (0, pg_core_1.uuid)('userId').references(() => users_1.users.id, { onDelete: 'cascade' }),
    addressId: (0, pg_core_1.uuid)('addressId').references(() => exports.addresses.id, { onDelete: 'cascade' }),
    rtoAddressId: (0, pg_core_1.uuid)('rtoAddressId').references(() => exports.addresses.id, { onDelete: 'set null' }),
