...
async function seedHolidays() {
    ...
    try {
        ...
        if (year) {
            ...
            console.log(`   ✅ Created: ${currentResult.created.length}, Skipped: ${currentResult.skipped.length}`);
            console.log('');
            console.log(`📅 Seeding ${nextYear}...`);
            const nextResult = await (0, holiday_service_1.seedDefaultNationalHolidays)(nextYear);
            console.log(`   ✅ Created: ${nextResult.created.length}, Skipped: ${nextResult.skipped.length}`);
            console.log('');
