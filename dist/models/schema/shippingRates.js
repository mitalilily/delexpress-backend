...
exports.shippingRates = (0, pg_core_1.pgTable)('shipping_rates', {
    ...
    plan_id: (0, pg_core_1.uuid)('plan_id')
        .references(() => plans_1.plans.id, { onDelete: 'cascade' })
        .notNull(),
...
exports.shippingRateSlabs = (0, pg_core_1.pgTable)('shipping_rate_slabs', {
    ...
    shipping_rate_id: (0, pg_core_1.uuid)('shipping_rate_id')
        .references(() => exports.shippingRates.id, { onDelete: 'cascade' })
        .notNull(),
    weight_from: (0, pg_core_1.decimal)('weight_from', { precision: 10, scale: 3 }).notNull(), // kg inclusive
    weight_to: (0, pg_core_1.decimal)('weight_to', { precision: 10, scale: 3 }), // kg inclusive; null = open ended
    rate: (0, pg_core_1.decimal)('rate', { precision: 10, scale: 2 }).notNull(),
